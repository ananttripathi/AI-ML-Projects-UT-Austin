...
├── enews-user-engagement-prediction/
...
- Supporting scripts, visuals, or reports (where applicable)
...
### 4️⃣ eNews User Engagement Prediction  
**Domain:** Supervised Machine Learning  
**Objective:**  
Build predictive models to identify users likely to subscribe based on behavioral and demographic attributes.
...
📁 Folder: `enews-user-engagement-prediction`
